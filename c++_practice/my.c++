...
void search_tree(struct root *l);
void push()
{
    static int cz = 0;
    if (top == max - 1)
...
void search_data(struct root *x, int xd)
{
    if (x == NULL)
    {
        return;
...
void tree_ds()
{
    ...
    do
    {
        ...
        default:
            printf("\nOperation not valid before insert Enter 1\nIf you entered 0 Exiting....!\n");
            break;
        }
